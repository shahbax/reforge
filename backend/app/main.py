...
from app.routers import analyses, billing, health, me, projects, scripts, tools, usage
...
def create_app() -> FastAPI:
    ...
    app.include_router(billing.router, prefix=prefix)  # stripe checkout + webhook
