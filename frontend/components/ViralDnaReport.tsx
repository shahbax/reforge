...
import { Badge, Card, Chips } from "./ui";

function List({ title, items }: { title: string; items: string[] }) {
  if (!items?.length) return null;
  return (
    <div>
      <div className="mb-1.5 text-xs font-medium uppercase tracking-wide text-muted-2">{title}</div>
    ...
    <div className="space-y-4">
      ...
      <Card className="border-accent/25 bg-gradient-to-br from-accent/10 to-transparent">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <div className="text-xs uppercase tracking-wide text-muted-2">Hook</div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card className="space-y-3">
          ...
          <div>
            <div className="mb-1.5 text-xs uppercase tracking-wide text-muted-2">Emotional progression</div>
        ...
        <Card className="space-y-3">
          <div>
            <div className="mb-1.5 text-xs uppercase tracking-wide text-muted-2">Narrative structure</div>
